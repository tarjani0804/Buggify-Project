        ...
        <div className="program-policy-div">
            ...
            <div className="program-policy-intro-div">
                ...
                <p className="program-policy-intro-div-p1">
                    ...
                    <br /><br /> We look forward to working with all security researchers and strive to be respectful, always assume the best and treat others as peers. We expect the same in return from all participants. To achieve this, our team strives to:
                    <ul>
                        <li>Reply to all reports within one business day and triage within two business days (if applicable)
                        </li>
                        <li>Be as transparent as possible, answering all inquires about our report decisions and adding hackers to duplicate HackerOne reports
                        </li>
                        <li>Award bounties within a week of triage (excluding extenuating circumstances)
                        </li>
                        <li>Only close reports as N/A when the issue reported is included in Known Issues, Ineligible Vulnerabilities Types or lacks evidence of a vulnerability
                        </li>
                        <li>Reopen and reward any report mistakenly closed as invalid if we later receive and reward the same bug reported by someone else. In these situations, we pay both hackers.
                        </li>
                        <li>If a duplicate report demonstrates a higher CVSS (e.g., a proof of concept with PR:N required versus PR:L on the original report), we re-calculate the CVSS and pay the bounty difference to the duplicate reporter.
                        </li>
                ...
                <p className="program-policy-intro-div-p3">
                    ...
                    <ul>
                        ...
                        <li>Generic examples of Host header attacks without evidence of the ability to target a remote victim</li>
                        ...
                        <li>Perceived security weaknesses without evidence of the ability to target a remote victim. For example credentials are transmitted in POST body as plain text, missing rate limits, bruteforcing without demonstrating impact, etc.</li>
                        <li>Self-XSS without a reasonable attack scenario. In general, we accept these reports when there are a maximum of two steps required. For example, pasting a malicious payload into an editor and then clicking to preview it would be two steps. </li>
                        <li>Access to individual paid features on an ineligible plan (for example, race conditions that lead to bypassing the limit of staff members for your current plan)</li>
                        <li>Perceived permission issues without impact on the integrity or confidentiality of data (ex. changing admin view settings, such as saved searches)</li>
                        <li> Open Redirects without demonstrating additional security impact (such as stealing auth tokens)</li>
                        <li>Reports exploiting the behaviour of, or vulnerabilities in, outdated browsers</li>
                        <li>False reports, or reports lacking evidence of a vulnerability</li>
                        <li>Reports of broken links or unclaimed social media accounts (unless chained with an impactful exploit)
                        </li>
                    </ul>
        ...
        <div className="program-sar-div">
            ...
            <div className="program-sar-info-div">
                ...
                <div className="program-reward-div">
                    ...
                    <div className="program-reward-div-p">Our max bounty is $100,000 for a Critical vulnerability. Valid Shopify non-core (defined below) vulnerabilities are calculated with Confidentiality, Integrity and Availability Requirements set to Low.</div>
...
function New_Updates() {
    return (
        <div style={{ color: "white" }}>1426383</div>
    )
}
                        ...
                        <div className="inner-program-heading-section-div1-2">
                            ...
                            <div className="inner-program-heading-section-div1-2-div">
                                ...
                                <div className="program-bookmark">
                                    <h5>Bookmark <span onClick={handleBookmark}><BsBookmarkPlus style={{ fontSize: "16px", marginLeft: "2px", cursor: "pointer", }} /> </span></h5>
                                    <h5 >Subscribe <HiOutlineBellAlert style={{ fontSize: "16px", marginLeft: "2px", cursor: "pointer" }} /> </h5>
                                </div>
                ...
                <div>
                    <nav className="program-navbar">
                        <ul className="program-navbar-ul">
                            ...
                            <li className={`program-navbar-ul-li  ${policySelect ? 'selecProgram-navbar' : 'program-navbar-ul-li'}`} onClick={handlePolicySelected}>Policy</li>
                            <li className={`program-navbar-ul-li  ${scopeSelected ? 'selecProgram-navbar' : 'program-navbar-ul-li'}`} onClick={handleScopeSelected}>Scope and Reward</li>
                            <li className={`program-navbar-ul-li  ${newUpdateSelected ? 'selecProgram-navbar' : 'program-navbar-ul-li'}`} onClick={handleNewUpdateSelected}>New Updates</li>
                        </ul>
