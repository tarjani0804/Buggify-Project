...
import Blog1 from '../image/Blog/Blog_1.png';
const Report = () => {
            ...
            <div className="blog-div" ref={scrollRef}>
                <div className="hero">
                    <div className="blog-heading hero-content">
                        <h1 className="hero__title blog-h mint">Ukraine Hit with New Golang-based 'SwiftSlicer' Wiper Malware in Latest Cyber Attack</h1>
