...
import Blog2 from '../image/Blog/Blog_2.png';
            ...
            <div className="blog-div" ref={scrollRef}>
                <div className="hero">
                    <div className="blog-heading hero-content">
                        <h1 className="hero__title blog-h mint">New High-Severity Vulnerabilities Discovered in Cisco IOx and F5 BIG-IP Products</h1>
                ...
                <div style={{
                    ...
                    <div className="blog-p1">
                        <p className="blog-p1-p">
                            <span style={{ fontSize: "20px", fontWeight: "900" }}>Cisco Patches Command Injection Bug in Cisco IOx</span>
