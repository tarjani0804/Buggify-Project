      ...
      <div className="company-c3" ref={scrollTo}>
        ...
        <center>
          <p className="company-c3-p">
            <span style={{ color: "#878787" }}></span>A Red Team Engagement
            Agreement is a legal document that outlines the scope, objectives,
            expectations, and responsibilities of a red team engagement between
            the organization and the red team provider(Buggify). It typically
            includes the following key elements :{" "}
          </p>
          <p className="company-c3-p">
            <span style={{ color: "#878787" }}>Purpose:</span> Private Red Team
            Engagement aims to nullify security flaws in systems of organization
            by collaborating with IT department.
          </p>
          <p className="company-c3-p">
          ...
          <p className="company-c3-p">
            ...
            Agreeing to This, Organizations agreed to participate in Our Private
            Red Team Engagement.
          </p>
        </center>
