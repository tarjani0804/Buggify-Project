        ...
        <>
            <div className="company-c3" ref={scrollTo}>
                ...
                <center>
                    ...
                    <p className="company-c3-p"><span style={{ color: "#878787" }}>Methods:</span>Testing methods and techniques that will be used during the engagement, including any tools or frameworks are a standards that is specifically designed.
                    </p>
                    <p className="company-c3-p"><span style={{ color: "#878787" }}>Deliverables:</span>Description of the final report and any other deliverables that will be provided to the client at the end of the engagement.
                    </p>
                    <p className="company-c3-p"><span style={{ color: "#878787" }}>Timelines:</span>Schedule of the start and end dates of the engagement, along with any milestones or deliverables due during the engagement will be discussed in CTO meeting.
                    </p>
                    <p className="company-c3-p"><span style={{ color: "#878787" }}>Confidentiality:</span>Every details of Assessment will be confidential using encryption through secret channel.
                    </p>
                    <p className="company-c3-p"><span style={{ color: "#878787" }}>Liability:</span>Statement outlining the liability of each party in the event of any damages or losses resulting from the engagement.
                    </p>
                ...
                <div className="button_ani company-c3-button">
